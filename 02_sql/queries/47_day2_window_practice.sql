...
SELECT
    ...
    CASE
    WHEN previous_available_month_sales IS NULL THEN '首次出现'
    WHEN total_net_sales > previous_available_month_sales THEN '增长'
    WHEN total_net_sales < previous_available_month_sales THEN '下降'
    ELSE '持平'
END AS trend_status
